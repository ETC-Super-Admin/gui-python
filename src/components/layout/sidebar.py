...
class Sidebar(QWidget):
    ...
    def __init__(self, theme_manager, username, role):
        ...
        self.buttons = {
            ...
            "delivery_management": self.shipping_label_submenu.delivery_management_button,
    ...
    def on_button_clicked(self, button_name):
        ...
        if button_name not in ["shipping_label", "label_asset", "sender_management", "receiver_management", "delivery_management"] and self.shipping_label_expanded:
            self.toggle_shipping_label_submenu()
    ...
    def set_active_button(self, button_name):
        ...
        for name, button in self.buttons.items():
            ...
            icon_name_map = {
                ...
                "shipping_label": 'fa5s.barcode', "label_asset": 'fa5s.box', "sender_management": 'fa5s.user-check', "receiver_management": 'fa5s.user-tag', "delivery_management": 'fa5s.truck'
            }
        ...
        is_shipping_active = button_name in ["shipping_label", "label_asset", "sender_management", "receiver_management", "delivery_management"]
